...
namespace FelipheGomez\PhpRestAPI\Cache {
...
namespace FelipheGomez\PhpRestAPI\Column\Reflection {

    use FelipheGomez\PhpRestAPI\Database\GenericReflection;
...
namespace FelipheGomez\PhpRestAPI\Column {

    use FelipheGomez\PhpRestAPI\Column\Reflection\ReflectedColumn;
    use FelipheGomez\PhpRestAPI\Column\Reflection\ReflectedTable;
    use FelipheGomez\PhpRestAPI\Database\GenericDB;
...
namespace FelipheGomez\PhpRestAPI\Column {
    ...
    use FelipheGomez\PhpRestAPI\Cache\Cache;
    use FelipheGomez\PhpRestAPI\Column\Reflection\ReflectedDatabase;
    use FelipheGomez\PhpRestAPI\Column\Reflection\ReflectedTable;
    use FelipheGomez\PhpRestAPI\Database\GenericDB;
...
namespace FelipheGomez\PhpRestAPI\Controller {

    use Psr\Http\Message\ResponseInterface;
    use Psr\Http\Message\ServerRequestInterface;
    use FelipheGomez\PhpRestAPI\Cache\Cache;
    use FelipheGomez\PhpRestAPI\Middleware\Router\Router;
...
namespace FelipheGomez\PhpRestAPI\Controller {
    ...
    use Psr\Http\Message\ResponseInterface;
    use Psr\Http\Message\ServerRequestInterface;
    use FelipheGomez\PhpRestAPI\Column\DefinitionService;
    use FelipheGomez\PhpRestAPI\Column\ReflectionService;
    use FelipheGomez\PhpRestAPI\Middleware\Router\Router;
    use FelipheGomez\PhpRestAPI\Record\ErrorCode;
    use FelipheGomez\PhpRestAPI\RequestUtils;
...
namespace FelipheGomez\PhpRestAPI\Controller {
    ...
    use Psr\Http\Message\ResponseInterface;
    use Psr\Http\Message\ServerRequestInterface;
    use FelipheGomez\PhpRestAPI\GeoJson\GeoJsonService;
    use FelipheGomez\PhpRestAPI\Middleware\Router\Router;
    use FelipheGomez\PhpRestAPI\Record\ErrorCode;
    use FelipheGomez\PhpRestAPI\RequestUtils;
...
namespace FelipheGomez\PhpRestAPI\Controller {
    ...
    use Psr\Http\Message\ResponseInterface;
    use FelipheGomez\PhpRestAPI\Record\Document\ErrorDocument;
    use FelipheGomez\PhpRestAPI\Record\ErrorCode;
    use FelipheGomez\PhpRestAPI\ResponseFactory;
...
namespace FelipheGomez\PhpRestAPI\Controller {
    ...
    use Psr\Http\Message\ServerRequestInterface;
    use FelipheGomez\PhpRestAPI\Middleware\Router\Router;
    use FelipheGomez\PhpRestAPI\OpenApi\OpenApiService;
...
namespace FelipheGomez\PhpRestAPI\Controller {
    ...
    use FelipheGomez\PhpRestAPI\Middleware\Router\Router;
    use FelipheGomez\PhpRestAPI\Record\ErrorCode;
    use FelipheGomez\PhpRestAPI\Record\RecordService;
    use FelipheGomez\PhpRestAPI\RequestUtils;
...
namespace FelipheGomez\PhpRestAPI\Database {
...
namespace FelipheGomez\PhpRestAPI\Database {
    ...
    use FelipheGomez\PhpRestAPI\Column\Reflection\ReflectedColumn;
    use FelipheGomez\PhpRestAPI\Record\Condition\AndCondition;
    use FelipheGomez\PhpRestAPI\Record\Condition\ColumnCondition;
    use FelipheGomez\PhpRestAPI\Record\Condition\Condition;
    use FelipheGomez\PhpRestAPI\Record\Condition\NoCondition;
    use FelipheGomez\PhpRestAPI\Record\Condition\NotCondition;
    use FelipheGomez\PhpRestAPI\Record\Condition\OrCondition;
    use FelipheGomez\PhpRestAPI\Record\Condition\SpatialCondition;
...
namespace FelipheGomez\PhpRestAPI\Database {
    ...
    use FelipheGomez\PhpRestAPI\Column\Reflection\ReflectedTable;
    use FelipheGomez\PhpRestAPI\Middleware\Communication\VariableStore;
    use FelipheGomez\PhpRestAPI\Record\Condition\ColumnCondition;
    use FelipheGomez\PhpRestAPI\Record\Condition\Condition;
...
namespace FelipheGomez\PhpRestAPI\Database {
    ...
    use FelipheGomez\PhpRestAPI\Column\Reflection\ReflectedColumn;
    use FelipheGomez\PhpRestAPI\Column\Reflection\ReflectedTable;
    use FelipheGomez\PhpRestAPI\Database\LazyPdo;
...
namespace FelipheGomez\PhpRestAPI\GeoJson {
...
namespace FelipheGomez\PhpRestAPI\GeoJson {
    ...
    use FelipheGomez\PhpRestAPI\Column\ReflectionService;
    use FelipheGomez\PhpRestAPI\GeoJson\FeatureCollection;
    use FelipheGomez\PhpRestAPI\Record\RecordService;
...
namespace FelipheGomez\PhpRestAPI\Middleware\Base {

    use Psr\Http\Server\MiddlewareInterface;
    use FelipheGomez\PhpRestAPI\Controller\Responder;
    use FelipheGomez\PhpRestAPI\Middleware\Router\Router;
...
namespace FelipheGomez\PhpRestAPI\Middleware\Communication {
...
namespace FelipheGomez\PhpRestAPI\Middleware\Router {

    use Psr\Http\Message\ResponseInterface;
    use Psr\Http\Message\ServerRequestInterface;
    use Psr\Http\Server\RequestHandlerInterface;
    use FelipheGomez\PhpRestAPI\Middleware\Base\Middleware;
...
namespace FelipheGomez\PhpRestAPI\Middleware\Router {
    ...
    use FelipheGomez\PhpRestAPI\Middleware\Base\Middleware;
    use FelipheGomez\PhpRestAPI\Record\ErrorCode;
    use FelipheGomez\PhpRestAPI\Record\PathTree;
    use FelipheGomez\PhpRestAPI\RequestUtils;
    use FelipheGomez\PhpRestAPI\ResponseUtils;
...
namespace FelipheGomez\PhpRestAPI\Middleware {
...
namespace FelipheGomez\PhpRestAPI\Middleware {
    ...
    use FelipheGomez\PhpRestAPI\Middleware\Router\Router;
    use FelipheGomez\PhpRestAPI\Record\ErrorCode;
    use FelipheGomez\PhpRestAPI\Record\FilterInfo;
    use FelipheGomez\PhpRestAPI\RequestUtils;
...
namespace FelipheGomez\PhpRestAPI\Middleware {
    ...
    use FelipheGomez\PhpRestAPI\Record\Condition\ColumnCondition;
    use FelipheGomez\PhpRestAPI\Record\ErrorCode;
    use FelipheGomez\PhpRestAPI\Record\OrderingInfo;
    use FelipheGomez\PhpRestAPI\RequestUtils;
	use FelipheGomez\PACMEC\SysSession;
...
namespace FelipheGomez\PhpRestAPI\OpenApi {

    use FelipheGomez\PhpRestAPI\Column\ReflectionService;
    use FelipheGomez\PhpRestAPI\OpenApi\OpenApiDefinition;
...
namespace FelipheGomez\PhpRestAPI\OpenApi {
    ...
    use FelipheGomez\PhpRestAPI\Column\ReflectionService;
    use FelipheGomez\PhpRestAPI\OpenApi\OpenApiBuilder;
...
namespace FelipheGomez\PhpRestAPI\Record\Condition {
...
namespace FelipheGomez\PhpRestAPI\Record\Document {
...
namespace FelipheGomez\PhpRestAPI\Record {
...
namespace FelipheGomez\PhpRestAPI\Record {
    ...
    class ErrorCode
    {
        ...
        private $values = [
            9999 => ["%s", 
            1000 => ["Route '%s' not found", 
            1001 => ["Table '%s' not found", 
            1002 => ["Argument count mismatch in '%s'", 
            1003 => ["Record '%s' not found", 
            1004 => ["Origin '%s' is forbidden", 
            1005 => ["Column '%s' not found", 
            1006 => ["Table '%s' already exists", 
            1007 => ["Column '%s' already exists", 
            1008 => ["Cannot read HTTP message", 
            1009 => ["Duplicate key exception", 
            1010 => ["Data integrity violation", 
            1011 => ["Authentication required", 
            1012 => ["Authentication failed for '%s'", 
            1013 => ["Input validation failed for '%s'", 
            1014 => ["Operation forbidden", 
            1015 => ["Operation '%s' not supported", 
            1016 => ["Temporary or permanently blocked", 
            1017 => ["Bad or missing XSRF token", 
            1018 => ["Only AJAX requests allowed for '%s'", 
            1019 => ["Pagination forbidden", 
            1020 => ["User '%s' already exists", 
            1021 => ["Password too short (<%d characters)", 
        ];*/
		private $values = [
            9999 => ["% s", ResponseFactory::INTERNAL_SERVER_ERROR],
            1000 => ["Ruta '%s' no encontrada", ResponseFactory::NOT_FOUND],
            1001 => ["Tabla '%s' no encontrada", ResponseFactory::NOT_FOUND],
            1002 => ["Discrepancia en el recuento de argumentos en '%s'", ResponseFactory::UNPROCESSABLE_ENTITY],
            1003 => ["Registro '%s' no encontrado", ResponseFactory::NOT_FOUND],
            1004 => ["El origen '%s' está prohibido", ResponseFactory::FORBIDDEN],
            1005 => ["Columna '%s' no encontrada", ResponseFactory::NOT_FOUND],
            ...
            1010 => ["Violación de la integridad de los datos", ResponseFactory::CONFLICT],
            1011 => ["Inicia sesion para continuar", ResponseFactory::UNAUTHORIZED],
            1012 => ["Error de autenticación para '%s'", ResponseFactory::FORBIDDEN],
            1013 => ["Error de validación de entrada para '%s'", ResponseFactory::UNPROCESSABLE_ENTITY],
            1014 => ["Operación prohibida", ResponseFactory::FORBIDDEN],
            1015 => ["Operación '%s' no admitida", ResponseFactory::METHOD_NOT_ALLOWED],
            1016 => ["Bloqueado temporal o permanentemente", ResponseFactory::FORBIDDEN],
            1017 => ["Token XSRF incorrecto o faltante", ResponseFactory::FORBIDDEN],
...
namespace FelipheGomez\PhpRestAPI\Record {
    ...
    use FelipheGomez\PhpRestAPI\Column\ReflectionService;
    use FelipheGomez\PhpRestAPI\Database\GenericDB;
    use FelipheGomez\PhpRestAPI\Record\Document\ListDocument;
...
namespace FelipheGomez\PhpRestAPI {

    use Psr\Http\Message\ResponseInterface;
    use Psr\Http\Message\ServerRequestInterface;
    use Psr\Http\Server\RequestHandlerInterface;
    use FelipheGomez\PhpRestAPI\Cache\CacheFactory;
    use FelipheGomez\PhpRestAPI\Column\DefinitionService;
    use FelipheGomez\PhpRestAPI\Column\ReflectionService;
    use FelipheGomez\PhpRestAPI\Controller\CacheController;
    use FelipheGomez\PhpRestAPI\Controller\ColumnController;
    use FelipheGomez\PhpRestAPI\Controller\GeoJsonController;
    use FelipheGomez\PhpRestAPI\Controller\JsonResponder;
    use FelipheGomez\PhpRestAPI\Controller\OpenApiController;
    use FelipheGomez\PhpRestAPI\Controller\RecordController;
    use FelipheGomez\PhpRestAPI\Database\GenericDB;
    use FelipheGomez\PhpRestAPI\GeoJson\GeoJsonService;
    use FelipheGomez\PhpRestAPI\Middleware\AuthorizationMiddleware;
    use FelipheGomez\PhpRestAPI\Middleware\BasicAuthMiddleware;
    use FelipheGomez\PhpRestAPI\Middleware\CorsMiddleware;
    use FelipheGomez\PhpRestAPI\Middleware\CustomizationMiddleware;
    use FelipheGomez\PhpRestAPI\Middleware\DbAuthMiddleware;
    use FelipheGomez\PhpRestAPI\Middleware\FirewallMiddleware;
    use FelipheGomez\PhpRestAPI\Middleware\IpAddressMiddleware;
    use FelipheGomez\PhpRestAPI\Middleware\JoinLimitsMiddleware;
    use FelipheGomez\PhpRestAPI\Middleware\JwtAuthMiddleware;
    use FelipheGomez\PhpRestAPI\Middleware\MultiTenancyMiddleware;
    use FelipheGomez\PhpRestAPI\Middleware\PageLimitsMiddleware;
    use FelipheGomez\PhpRestAPI\Middleware\ReconnectMiddleware;
    use FelipheGomez\PhpRestAPI\Middleware\Router\SimpleRouter;
    use FelipheGomez\PhpRestAPI\Middleware\SanitationMiddleware;
    use FelipheGomez\PhpRestAPI\Middleware\SslRedirectMiddleware;
    use FelipheGomez\PhpRestAPI\Middleware\ValidationMiddleware;
    use FelipheGomez\PhpRestAPI\Middleware\XmlMiddleware;
    use FelipheGomez\PhpRestAPI\Middleware\XsrfMiddleware;
    use FelipheGomez\PhpRestAPI\OpenApi\OpenApiService;
    use FelipheGomez\PhpRestAPI\Record\ErrorCode;
    use FelipheGomez\PhpRestAPI\Record\RecordService;
    use FelipheGomez\PhpRestAPI\ResponseUtils;
...
namespace FelipheGomez\PACMEC {
	use FelipheGomez\PACMEC\Conectar;
	...
	class SysSession implements SessionHandlerInterface {
		...
		public function read($id) {
			try {
				$result = $this->link->FetchObject("SELECT Session_Data FROM {$this->link->getPrefix()}sessions WHERE Session_Id=? AND Session_Expires > ?", [$id, date('Y-m-d H:i:s')]);;
		...
		public function write($id, $data) {
			try {
				...
				$result = $this->link->FetchObject("REPLACE INTO {$this->link->getPrefix()}sessions SET Session_Id=?, Session_Expires=?, Session_Data=?", [$id, $NewDateTime, $data]);
		...
		public function destroy($id) {
			try {			
				$result = $this->link->FetchObject("DELETE FROM {$this->link->getPrefix()}sessions WHERE Session_Id =?", [$id]);
				if($result !== false){ return true; } else { return false; }
			}
			catch(Exception $e){ 
				echo $e->getMessage();
		...
		public function gc($maxlifetime) {
			try {			
				$result = $this->link->FetchObject("DELETE FROM {$this->link->getPrefix()}sessions WHERE ((UNIX_TIMESTAMP(Session_Expires) + ?) < ?)", [$maxlifetime, $maxlifetime]);
				if($result !== false){ return true; } else { return false; }
			}
			catch(Exception $e){ 
				echo $e->getMessage();
...
namespace FelipheGomez\PhpRestAPI {
	...
	use FelipheGomez\PhpRestAPI\Api;
	use FelipheGomez\PhpRestAPI\RequestFactory;
	use FelipheGomez\PhpRestAPI\ResponseUtils;
	...
	$config = new Config([
		...
		'dbAuth.usersTable' => DB_prefix.'users',
